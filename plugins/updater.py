# Petercord panda userbot
# copyright 2021 (c) by ilhamm
# ilham mansiz
...
UPSTREAM_REPO_URL = "https://github.com/IlhamMansiez/PandaX_Userbot"
...
async def upstream(ups):
    ...
    if Var.HEROKU_API is not None:
        ...
        args = [sys.executable, "./resources/startup/panda.sh"]
