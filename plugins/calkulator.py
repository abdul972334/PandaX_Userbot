...
@ilhammansiz_cmd(pattern="calc")
async def icalc(e):
    udB.delete("calc")
    results = await petercordpanda_bot.inline_query(asst.me.username, "calc")
...
async def _(e):
    ...
    calc = e.builder.article("Calc", text="• PandaUserbot Inline Calculator •", buttons=lst)
    await e.answer([calc])
...
async def _(e):
    ...
    if x == "AC":
        udB.delete("calc")
        return await e.edit(
            "• PandaUserbot Inline Calculator •",
