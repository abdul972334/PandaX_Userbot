...
from PandaX_Userbot.functions.greetings_db import *
...
@ilhammansiz_cmd(pattern="setwelcome")
...
@ilhammansiz_cmd(pattern="clearwelcome$")
...
@ilhammansiz_cmd(pattern="getwelcome$")
...
@ilhammansiz_cmd(pattern="setgoodbye")
...
@ilhammansiz_cmd(pattern="cleargoodbye$")
...
@ilhammansiz_cmd(pattern="getgoodbye$")
